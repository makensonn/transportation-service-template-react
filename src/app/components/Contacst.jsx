...
const titleStyle = 'text-4xl font-bold inline border-b-4 text-[#000000] border-[#FF0000]'
    ...
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          {/* left */}
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-neutral-950 rounded-xl p-4'>
          ...
          {/* right */}
          <div className='col-span-3 w-full h-auto shadow-xl shadow-neutral-950 rounded-xl lg:p-4'>
            <div className='p-4'>
              <form
